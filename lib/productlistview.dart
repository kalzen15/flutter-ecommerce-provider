...
List<Product> prod = _getProducts();
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
              ...
              subtitle: Text(prod[index].price.toString()),
              trailing: Checkbox(
                value: prod[index].inCart,
                onChanged: (value) {
                  setState(() {
                    prod[index].inCart = value;
                  });
                  print(prod[index].inCart);
                  value ? ccart.add(prod[index]) : ccart.remove(prod[index]);
                  print(prod[index].inCart);
                },
              ));
        });
